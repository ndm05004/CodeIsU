...
<script   src="https://code.jquery.com/jquery-3.7.0.min.js"   integrity="sha256-2Pmvv0kuTBOenSvLm6bvfBSSHrUJ+3A7x6P5Ebd07/g="   crossorigin="anonymous"></script>
  ...
  <!-- CSS Files -->
  <link id="pagestyle" href="${pageContext.request.contextPath}/pms/assets/css/material-dashboard.css?v=3.1.0" rel="stylesheet" />
...
<body>
  ...
  <div class="bg-gray-100 main-container-kt">
    <!-- top시작 -->
    <!-- 왼쪽 네비바 -->
    <aside class="sidenav navbar navbar-vertical navbar-expand-xskt border-0 border-radius-xl my-3 ms-1   bg-gradient-dark"
      ...
      <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="javascript:goToMenu('stu_stumain')">
          target="_blank">
          <img src="${pageContext.request.contextPath}/pms/assets/img/ddit_logo04.png" class="navbar-brand-img h-100" alt="main_logo">
          <span class="ms-1 font-weight-bold text-white">M2</span>
        </a>
      </div>
      ...
      <div class=" navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link text-white " href="${pageContext.request.contextPath}/pms/tables.html">
          ...
          <li class="nav-item">
            <a class="nav-link text-white " href="${pageContext.request.contextPath}/pms/billing.html">
          ...
          <li class="nav-item">
            <a class="nav-link text-white " href="${pageContext.request.contextPath}/pms/virtual-reality.html">
          ...
          <li class="nav-item">
            <a class="nav-link text-white " href="${pageContext.request.contextPath}/pms/rtl.html">
          ...
          <li class="nav-item">
            <a class="nav-link text-white " href="${pageContext.request.contextPath}/pms/notifications.html">
          ...
          <li class="nav-item">
            <a class="nav-link text-white " href="${pageContext.request.contextPath}/pms/profile.html">
          ...
          <li class="nav-item">
            <a class="nav-link text-white " href="${pageContext.request.contextPath}/pms/sign-in.html">
          ...
          <li class="nav-item">
            <a class="nav-link text-white " href="${pageContext.request.contextPath}/pms/sign-up.html">
      ...
      <div class="sidenav-footer position-absolute w-100 bottom-0 ">
        <div class="mx-3">
          <a class="btn btn-outline-info mt-4 w-100"
          ...
          <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
            ...
            <ul class="navbar-nav  justify-content-end">
              ...
              <!--알람끝-->
                ...
                <li class="nav-item d-flex align-items-center">
                  <a href="/member/logout" class="nav-link text-body font-weight-bold px-0">
